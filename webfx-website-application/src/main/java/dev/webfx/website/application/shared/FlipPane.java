...
public class FlipPane extends StackPane {
    ...
    private final ObjectProperty<Node> frontProperty = new SimpleObjectProperty<Node>() {
        @Override
    ...
    private final ObjectProperty<Node> backProperty = new SimpleObjectProperty<Node>() {
        @Override
        protected void invalidated() {
            onNodesChanged();
        }
    ...
    private final ObjectProperty<Orientation> flipDirectionProperty = new SimpleObjectProperty<Orientation>() {
        @Override
