...
public final class FullStackJavaCard extends Card {
        ...
        pane = new Pane(circlePanes) {
            ...
            protected void layoutChildren() {
                ...
                if (currentAnimationStep == 7) {
                    ...
                    layoutInArea(puzzles[1], wd2 - pr, yc - r * 0.65 - pr, pd, pd, 0, HPos.CENTER, VPos.CENTER);
                    layoutInArea(puzzles[2], wd2 - 0.55 * r - pr, yc + r * 0.25 - pr, pd, pd, 0, HPos.CENTER, VPos.CENTER);
                    layoutInArea(puzzles[3], wd2 + 0.55 * r - pr, yc + r * 0.25 - pr, pd, pd, 0, HPos.CENTER, VPos.CENTER);
                }
            }
        };
    ...
    String caption(int step) {
        switch (step) {
            ...
            case 2: return "Having different UI toolkits and languages makes your stack more complex, and prevents you to share any common code.";
    ...
    private void updateFlipPanels(FlipPanel[] flipPanels, Node[] logos, int step, CardTransition cardTransition) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            pane.getChildren().remove(stepLogo);
